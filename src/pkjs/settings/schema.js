  ...
  tabs: [
    { id: 'weather', label: 'Weather', sections: [
      { title: 'Weather', items: [
        ...
        { type: 'text', messageKey: 'location', label: 'Location override', defaultValue: '',
          attributes: { placeholder: 'Using GPS' }, hint: 'Example: "Manhattan" or "123 Oak St Plainsville KY". Leave blank for GPS.' },
